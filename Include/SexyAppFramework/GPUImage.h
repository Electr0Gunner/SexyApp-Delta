...
namespace Sexy
{
	...
	public:
		...
		static bool Check3D(GPUImage* theImage)  {return false;};
		static bool Check3D(Image* theImage)  {return false;};
	...
	public:
		...
		virtual ulong* GetBits() {return nullptr;};

		virtual bool PolyFill3D(
			const Point theVertices[], int theNumVertices, const Rect* theClipRect, const Color& theColor, int theDrawMode, int tx, int ty, bool comvex) {return false;};
