...
namespace Sexy
{
	...
	public:
		...
		virtual Rect WriteCenteredLine(
			Graphics* g, int anOffset, const SexyString& theLine, Color theColor1, Color theColor2, const Point& theShadowOffset = Point(1, 2));

		virtual int WriteString(Graphics* g, const SexyString& theString, int theX, int theY, int theWidth = -1, int theJustification = -1,
