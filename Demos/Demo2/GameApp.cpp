...
void GameApp::LoadingThreadProc()
{
	...
	mOpaqueBeamImg = (GPUImage*) GetImage("images/beam_opaque");
	...
	mMoonImg = (GPUImage*) GetImage("images/moon");
	if (mMoonImg == nullptr)
	{
	...
	((GPUImage*)mOpaqueBeamImg)->Palletize();
	((GPUImage*)mMoonImg)->Palletize();
	((GPUImage*)mTurbotImg)->Palletize();
