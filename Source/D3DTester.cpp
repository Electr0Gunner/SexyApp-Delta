...
#include <SexyAppFramework/D3D8Helper.h>
...
void D3DTestImage::DrawPieceToDevice(
	LPDIRECT3DDEVICE7 theDevice, LPDIRECTDRAWSURFACE7 theTexture, float x, float y, int offx, int offy, int texWidth, int texHeight, DWORD theColor)
{
	...
	D3DTLVERTEX aVertex[4] = { { x, y, 0, 1, theColor, 0, 0, 0 }, { x, y + texHeight, 0, 1, theColor, 0, 0, maxV },
		{ x + texWidth, y, 0, 1, theColor, 0, maxU, 0 }, { x + texWidth, y + texHeight, 0, 1, theColor, 0, maxU, maxV } };
...
bool D3DTester::Init(HWND theHWND, LPDIRECTDRAW7 theDDraw)
{
	...
	if (mCheckRegistry)
	{
		...
		RegCreateKeyExA(HKEY_CURRENT_USER, aKey.c_str(), 0, nullptr, REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, nullptr, &mRegKey, nullptr);
	}
